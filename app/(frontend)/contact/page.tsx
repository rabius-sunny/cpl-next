          ...
          <div className="space-y-28 mx-auto px-4 max-w-7xl container">
            <div className="space-y-16 bg-white lg:shadow-xl ml-0 p-5 lg:p-16 rounded-sm w-full max-w-2xl">
              ...
              <div className="gap-5 grid grid-cols-2 w-full">
                <Link href={'/'} className="w-full">Contact</Link>
                <Link href={'https://www.google.com/maps/place/Creative+Paper+Mills+Ltd./@23.7582897,90.391711,12z/data=!4m6!3m5!1s0x3755b61df55d91f9:0x2debbb343d8464a7!8m2!3d23.7624931!4d90.5110292!16s%2Fg%2F11dyzdkb_3?entry=ttu&g_ep=EgoyMDI1MDUyOC4wIKXMDSoASAFQAw%3D%3D'} target="_blank" className="">See Google Map</Link>
              </div>
            </div>
          </div>
        </div>
